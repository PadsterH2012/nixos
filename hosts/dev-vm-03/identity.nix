# Identity configuration for dev-vm-03
...

{
  ...
  environment.etc."machine-id".text = "dev-vm-03";

  # Custom wallpaper showing machine identity
  # environment.etc."wallpaper.png".source = ../../wallpapers/dev-vm-03.png;
  ...
  services.xserver.desktopManager.cinnamon = {
    ...
    extraSessionCommands = ''
      ...
      ${pkgs.libnotify}/bin/notify-send "Development VM" "Machine: dev-vm-03\nIP: $(hostname -I | awk '{print $1}')" --icon=computer
    '';
  };

  # Host-specific environment variables
  environment.variables = {
    HOSTNAME_DISPLAY = "dev-vm-03";
    VM_ROLE = "development";
    VM_NUMBER = "03";
  };
}
