# Identity configuration for dev-vm-04
...

{
  ...
  environment.etc."machine-id".text = "dev-vm-04";

  # Custom wallpaper showing machine identity
  # environment.etc."wallpaper.png".source = ../../wallpapers/dev-vm-04.png;
  ...
  services.xserver.desktopManager.cinnamon = {
    ...
    extraSessionCommands = ''
      ...
      ${pkgs.libnotify}/bin/notify-send "Development VM" "Machine: dev-vm-04\nIP: $(hostname -I | awk '{print $1}')" --icon=computer
    '';
  };

  # Host-specific environment variables
  environment.variables = {
    HOSTNAME_DISPLAY = "dev-vm-04";
    VM_ROLE = "development";
    VM_NUMBER = "04";
  };
}
